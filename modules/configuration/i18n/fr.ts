...
const fr = {
  configuration: {
    ...
    inUse:
      "Impossible de supprimer — {count} fiche(s) dans {tables} autre(s) table(s) y font encore référence.",
    inUseLine: "• {table} — {count}",
    inUseHint: "Retirez-les ou réaffectez-les d'abord.",
    records: {
      Assessment: "Contrôles",
      Bulletin: "Bulletins",
      BulletinLine: "Lignes de bulletin",
      CashOperation: "Opérations de caisse",
      ChatChannel: "Conversations",
      Cheque: "Chèques",
      ClassGroup: "Groupes",
      Discount: "Réductions",
      DocumentRequest: "Demandes de documents",
      Enrollment: "Inscriptions",
      EnrollmentFee: "Frais d'inscription",
      EnrollmentOption: "Options d'inscription",
      EventAudience: "Destinataires d'événements",
      FeeRate: "Tarifs",
      Guardian: "Tuteurs",
      Level: "Niveaux",
      LevelOffering: "Niveaux ouverts",
      LevelSubject: "Lignes de programme",
      Neighbourhood: "Quartiers",
      OperationMotif: "Motifs d'opération",
      OperationSubcategory: "Sous-catégories d'opération",
      PaymentTender: "Règlements",
      Profile: "Fiches du personnel",
      RouteNeighbourhood: "Quartiers desservis",
      RouteSchedule: "Horaires de ligne",
      RouteStop: "Arrêts",
      SchoolClass: "Classes",
      Student: "Élèves",
      StudentAttendance: "Présences",
      StudentDocument: "Pièces du dossier",
      StudentRemark: "Remarques",
      Subject: "Matières",
      Supplier: "Fournisseurs",
      SupplyItem: "Articles des listes",
      SupplyList: "Listes de fournitures",
      TeacherSubject: "Matières enseignées",
      TeacherSubjectLevel: "Niveaux enseignés",
      TeacherUnavailability: "Indisponibilités",
      TeachingAssignment: "Affectations d'enseignement",
      TimetableEntry: "Séances",
      TimetableException: "Modifications d'emploi du temps",
      Track: "Filières",
      TransportAttendance: "Pointages de transport",
      TransportSubscription: "Abonnements de transport",
      TripRun: "Trajets",
    },
    ...
    resources: {
      ...
      staffFunctions: "Fonctions",
      parentJobs: "Professions des parents",
      terms: "Semestres",
