...
const ar = {
  configuration: {
    ...
    resources: {
      ...
      requestTypes: "الوثائق القابلة للطلب",
      suppliers: "\u0627\u0644\u0645\u0632\u0648\u0651\u062f\u0648\u0646",
      banks: "الأبناك",
      ...
      staffFunctions: "المهام",
      parentJobs: "مهن الآباء",
      terms: "الدورات",
      holidays: "العطل",
    ...
    fields: {
      ...
      copies: "\u0627\u0644\u0646\u0633\u062e",
      documentNotes: "\u062a\u0648\u0636\u064a\u062d",
      requestDescription: "الغرض منها",
      requestDescriptionAr: "الغرض منها (بالعربية)",
      usualDelayDays: "الأجل المعتاد (أيام)",
      requiresReason: "طلب ذكر الغرض",
      colorHex: "اللون",
    ...
    hints: {
      ...
      teachingDays:
        "الأيام التي تُدرَّس فيها الحصص. اليوم الذي لا مساء فيه يبقى هنا — ويُرفع مساؤه في الخانة التالية.",
      freeAfternoonDays:
        "أنصاف الأيام التي تنتهي عند الزوال — أيها شئت وبالعدد الذي تأخذه المؤسسة. بلا اختيار: الدراسة كل مساء.",
      dayStartsAt:
        "نقطة الانطلاق. كل حصص الصباح تتبعها، فمدرسة تفتح على الثامنة والنصف تغيّر هذا الإعداد وحده لا التوقيت كله.",
      periodMinutes:
        "مدة الحصة الواحدة. تغييرها لا يحرّك حصص سنة سبق وضعها — تلك تحت الحصص الزمنية.",
      periodsBeforeBreak:
        "عدد الحصص قبل الاستراحة في كل فترة. الصفر يضع السلسلة بلا استراحة.",
      supplierKind:
      ...
      requestDescription:
        "يظهر للأسرة تحت الاسم، حيث تختار بين وثائق لا تعرفها جيدا.",
      usualDelayDays:
        "يقترح التاريخ عند قبول الطلب. اتركه فارغا إن لم ترد الالتزام بأجل.",
      requiresReason:
        "للوثائق التي لا تُحرر دون معرفة الغرض — الصياغة تختلف باختلاف الجهة.",
      supplyCategory:
      ...
      qualificationCycle:
        "اتركه فارغًا للأستاذ الذي يدرّس المادة في جميع الأسلاك. يُهمل بمجرد تحديد مستويات أسفله.",
      qualificationLevels:
        "المستويات التي يمكن أن تُسند فيها المادة لهذا الأستاذ. لا تحدّد أي مستوى ليُعتمد السلك أعلاه، أو المدرسة كاملة إن كان فارغًا بدوره.",
      preferenceRank:
