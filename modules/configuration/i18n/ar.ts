...
const ar = {
  configuration: {
    ...
    inUse:
      "لا يمكن الحذف — ما زال {count} سجلًا في {tables} جدولًا آخر يشير إليه.",
    inUseLine: "• {table} — {count}",
    inUseHint: "احذفها أو أعد ربطها أولاً.",
    records: {
      Assessment: "الفروض",
      Bulletin: "بيانات النقط",
      BulletinLine: "سطور بيان النقط",
      CashOperation: "عمليات الصندوق",
      ChatChannel: "المحادثات",
      Cheque: "الشيكات",
      ClassGroup: "المجموعات",
      Discount: "التخفيضات",
      DocumentRequest: "طلبات الوثائق",
      Enrollment: "التسجيلات",
      EnrollmentFee: "رسوم التسجيل",
      EnrollmentOption: "خيارات التسجيل",
      EventAudience: "المعنيون بالأنشطة",
      FeeRate: "التعريفات",
      Guardian: "الأولياء",
      Level: "المستويات",
      LevelOffering: "المستويات المفتوحة",
      LevelSubject: "سطور المقرر",
      Neighbourhood: "الأحياء",
      OperationMotif: "دواعي العمليات",
      OperationSubcategory: "الأصناف الفرعية للعمليات",
      PaymentTender: "وسائل الأداء",
      Profile: "بطاقات الموظفين",
      RouteNeighbourhood: "أحياء الخط",
      RouteSchedule: "توقيتات الخط",
      RouteStop: "المحطات",
      SchoolClass: "الأقسام",
      Student: "التلاميذ",
      StudentAttendance: "الحضور",
      StudentDocument: "وثائق التلميذ",
      StudentRemark: "ملاحظات التلاميذ",
      Subject: "المواد",
      Supplier: "الموردون",
      SupplyItem: "مواد اللوائح",
      SupplyList: "لوائح اللوازم",
      TeacherSubject: "المواد المدرَّسة",
      TeacherSubjectLevel: "المستويات المدرَّسة",
      TeacherUnavailability: "فترات عدم التوفر",
      TeachingAssignment: "الإسنادات التدريسية",
      TimetableEntry: "الحصص",
      TimetableException: "تغييرات استعمال الزمن",
      Track: "الشعب",
      TransportAttendance: "تتبع النقل",
      TransportSubscription: "اشتراكات النقل",
      TripRun: "الرحلات",
    },
    ...
    resources: {
      ...
      gradingRules: "سلالم التنقيط",
      gradingScale: "سلم التنقيط",
      rooms: "القاعات",
      cities: "المدن",
    ...
    fields: {
      ...
      reportMaxScore: "تُنقط الشواهد من",
      ...
      maxScore: "النقطة القصوى",
      gradingMaxScore: "سلم المؤسسة",
      passMarkBps: "نقطة النجاح",
    ...
    hints: {
      ...
      reportMaxScore:
        "السلم الذي تُصاغ به معدلات هذا المستوى وشواهده. اتركه فارغا لاعتماد سلم المؤسسة.",
      gradingRuleLevel: "اتركه فارغا ليُطبَّق على جميع المستويات.",
      gradingRuleSubject: "اتركه فارغا ليُطبَّق على جميع مواد المستوى.",
      gradingRuleMaxScore:
        "ما يُنقَّط عليه فرض جديد من هذا النوع انطلاقا من هنا. لا يُعيد تنقيط دورة سبق إجراؤها — انظر ملاحظة GradingRule.",
      gradingRuleCoefficient: "اتركه فارغا للاحتفاظ بوزن النوع نفسه.",
      gradingMaxScore: "ما تنقّط عليه المؤسسة حين لا يحدد المستوى شيئا خاصا به.",
      passMarkBps: "كنسبة من السلم أعلاه: 50 تجعل 10/20، أو 10/10، نجاحا.",
