...
const en = {
  timetable: {
    ...
    day: "Day",
    teacherWeekTitle: "This teacher's week",
    teacherWeekSummary: "{lessons} lessons across {classes} classes.",
    teacherWeekEmpty: "{name} has no lesson on this bell schedule yet.",
    ...
    printWithDetails: "Print with details",
    detailEditTip: "Set what is taught in this period, and when",
    detailTitle: "Details of {subject} · {time}",
    detailHint:
      "The lesson stays as it is. Add what is taught inside it and when, e.g. Grammar 08:00–08:30. It is shown under the subject on the timetable.",
    detailSubject: "Subject or component",
    detailFrom: "From",
    detailTo: "To",
    detailAdd: "Add a detail",
    detailRemove: "Remove",
    detailsSaved: "Details saved.",
    detailsInvalid:
      "Each detail needs a start before its end, inside the period, and the same subject cannot start twice at the same time.",
    pickTeacher: "Teacher",
