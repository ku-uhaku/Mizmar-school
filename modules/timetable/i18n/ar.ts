...
const ar = {
  timetable: {
    ...
    replaceSlots: "استبدال فترات هذه الحصة في هذه الأيام",
    replaceSlotsHint:
      "ضروري لتغيير مدة فترات يوم ما، مثل الجمعة من ساعة ونصف إلى ساعة. يُرفض إذا كانت هناك حصص موضوعة فيها.",
    replaceBlocked:
      "توجد {count} حصة في هذه الفترات. أفرغها من الجدول أولاً، أو أعد التوليد بعد ذلك.",
    ...
    minutesPlaced: "تم وضع {placed} من أصل {requested}",
    overshoot: "زيادة {duration} — الفترات لا تقسم البرنامج بالتساوي",
    lessonPerSlot: "حصة واحدة لكل فترة",
    slotPickerTitle: "الفترات المراد ملؤها",
    slotPickerHint:
      "ألغِ تحديد فترة أو يوم لاستبعادها من هذا التوليد. تُظهر كل فترة مدتها.",
    subjectRulesTitle: "المواد",
    subjectRulesHint:
      "ألغِ تحديد مادة لاستبعادها من هذا التوليد، أو اختر أين يمكن وضعها. لا يُحفظ شيء هنا.",
    leftOutByYou: "مستبعدة من هذا التوليد",
    modeAny: "أي فترة",
    modeOnly: "في هذه الفترات فقط",
    modeFixed: "مثبتة في هذه الفترات",
    modeOnlyHint: "لا تُوضع المادة إلا في الفترات المحددة. عدم تحديد أي فترة يعني بلا قيد.",
    modeFixedHint: "تُوضع المادة في الفترات المحددة تحديدًا، ويُوزَّع باقي ساعاتها حولها.",
    pinNeedsOneClass: "تثبيت مادة في فترات يتطلب قسمًا واحدًا. غيّر النطاق إلى هذا القسم لاستخدامه.",
