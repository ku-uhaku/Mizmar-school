...
const fr = {
  timetable: {
    ...
    printWithDetails: "Imprimer avec détails",
    detailEditTip: "Préciser ce qui est enseigné dans cette séance, et à quelle heure",
    detailTitle: "Détails de {subject} · {time}",
    detailHint:
      "Le cours reste tel quel. Ajoutez ce qui est enseigné dedans et quand, par ex. Grammaire 08:00–08:30. Cela s'affiche sous la matière dans l'emploi du temps.",
    detailSubject: "Matière ou composante",
    detailFrom: "De",
    detailTo: "À",
    detailAdd: "Ajouter un détail",
    detailRemove: "Retirer",
    detailsSaved: "Détails enregistrés.",
    detailsInvalid:
      "Chaque détail doit commencer avant sa fin, dans la séance, et la même matière ne peut pas commencer deux fois à la même heure.",
