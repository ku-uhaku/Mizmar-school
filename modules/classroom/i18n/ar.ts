...
const ar = {
  classroom: {
    ...
    sessions: "الحصص",
    session: "الحصة",
    sessionsHint: "حصص اليوم، وما أُنجز فيها، ومن كان حاضرًا.",
    theme: "موضوع الحصة",
    themePlaceholder: "ما تمت دراسته.",
    homework: "العمل المطلوب",
    homeworkPlaceholder: "ما يجب على القسم تحضيره للمرة القادمة.",
    saveSession: "حفظ الحصة",
    sessionSaved: "تم حفظ الحصة — تم تسجيل {count} تلميذًا.",
    sessionClosed: "مقفلة",
    sessionClosedHint: "ورقة الحضور نهائية. أعد فتح الحصة لتعديل حضور.",
    sessionAlreadyClosed: "هذه الحصة مقفلة. أعد فتحها قبل الحفظ من جديد.",
    reopenSession: "إعادة الفتح",
    sessionReopened: "تمت إعادة فتح الحصة.",
    sessionCancelled: "لم تُنجز",
    markCancelled: "حصة لم تُنجز",
    markCancelledHint: "لا تُسجَّل ورقة حضور لهذه الحصة.",
    notTakenYet: "في انتظار الإنجاز",
    taken: "أُنجزت",
    periodCount: "{count} حصص",
    journal: "دفتر النصوص",
    journalHint: "ما أُنجز مع هذا القسم، من الأحدث إلى الأقدم.",
    noSessionsYet: "لم تُسجَّل أي حصة بعد.",
    noSessionsYetHint: "اختر حصة أعلاه، واكتب الموضوع، ثم سجّل الحضور.",
    noTheme: "لم يُكتب أي موضوع.",
    presentByDefault:
      "الجميع يُحتسبون حاضرين. سجّل الغائبين والمتأخرين فقط.",
    absentCount: "{count} غائبون",
    lateCount: "{count} متأخرون",
    presentCount: "{count} حاضرون",
    findPupil: "البحث عن تلميذ",
    ...
    // ── يوم القسم، انطلاقًا من بطاقته ──────────────────────────────────────
    dayRegisterHint: "حصص اليوم، والمناداة التي أُنجزت.",
    chooseLesson: "اختر حصة",
    noLessonsOnDay: "لا حصة في جدول هذا القسم في ذلك اليوم.",
    noLessonsOnDayHint:
      "اختر تاريخًا آخر، أو ارسم أسبوع القسم في تبويب استعمال الزمن.",
    schoolClosed: "{name} — المدرسة مغلقة.",
    weekNotTaught: "أسبوع غير دراسي.",
    lessonCancelled: "ملغاة",
    lessonReplaced: "معوَّضة",
    registerPending: "لم تُنجز",
    markedOfRoster: "{marked} من {total} مسجَّلين",
    notMarked: "غير مسجَّلين",
    standingIn: "تُسجَّل المناداة باسمك، كما لو أنك أجريت الحصة.",
    groupLessonWholeClass:
      "حصة خاصة بالمجموعة {group}. المناداة تشمل القسم كاملًا.",
    cannotMark: "يمكنك الاطلاع على المناداة دون إجرائها.",
    ...
    papersToMarkHint:
      "فروضك المحروسة وواجباتك الخاصة. أدخل النقط ثم سلّم الفروض.",

    // ── الموضوع ─────────────────────────────────────────────────────────────
    questions: "الأسئلة",
    questionsHint:
      "اختياري. اكتب الموضوع هنا، والنقطة القصوى تتبع السلّم الذي تمنحه لكل سؤال.",
    questionPlaceholder: "نصّ السؤال",
    questionPoints: "النقط",
    addQuestion: "إضافة سؤال",
    removeQuestion: "حذف هذا السؤال",
    questionsTotal: "السلّم: {total} نقطة",
    noQuestions: "لم يُحرَّر أي موضوع لهذا الواجب.",
    ...
    remarkPublished: "تم إرسال الملاحظة إلى الأسرة.",
    remarkUnpublished: "تم سحب الملاحظة من الأسرة.",
    awaitingRelease: "في انتظار المصادقة",
    releaseToFamily: "إرسال إلى الأسرة",
    withdrawFromFamily: "سحب",
