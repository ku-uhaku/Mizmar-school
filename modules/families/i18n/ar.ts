...
const ar = {
  family: {
    ...
    firstContactSectionHint:
      "الولي الذي ستتصل به المدرسة أولًا. يُفتح له تلقائيًا حساب في تطبيق الأولياء، بكلمة مرور عشوائية تُعرض مرة واحدة بعد إنشاء الملف.",
    guardianPhoneHint: "اتركه فارغًا لاستخدام هاتف الأسرة أعلاه.",
    guardians: "الأولياء",
