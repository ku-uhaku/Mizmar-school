...
const ar = {
  treasury: {
    ...
    reference: "المرجع",
    drawer: "الصندوق",
    drawerHint: "الصندوق الذي تخرج منه النقود.",
    drawerMine: "صندوقك",
    moreDetails: "تفاصيل إضافية",
    moreDetailsHint: "المورّد، البند، السبب، التاريخ، الملاحظات — كلها اختيارية.",
    occurredAt: "التاريخ",
  ...
  treasuryOptions: {
    ...
    methods: {
      ...
      VERSEMENT: "إيداع بنكي",
      PRELEVEMENT: "استخلاص تلقائي",
      TPE: "بطاقة بنكية",
      MANDAT: "حوالة",
      MIXED: "مختلط",
    },
