...
const fr = {
  treasury: {
    ...
    noOperationMatches: "Aucun mouvement ne correspond à ces filtres.",
    operationCount: "{count} mouvements",
    operationPage: "Page {page} sur {pages}",
    allKinds: "Tous les types",
    allMethods: "Tous les modes",
    allStatuses: "Tous les statuts",
    searchOperations: "Libellé, référence ou bénéficiaire",
    searchReceipts: "Numéro de reçu ou famille",
    dateFrom: "Du",
    dateTo: "Au",
    ...
    noReceiptMatches: "Aucun reçu ne correspond à ces filtres.",
    payments: "R\u00e8glements",
    receiptNumber: "Re\u00e7u",
