...
const en = {
  treasury: {
    ...
    noOperationMatches: "No movement matches these filters.",
    operationCount: "{count} movements",
    operationPage: "Page {page} of {pages}",
    allKinds: "Every type",
    allMethods: "Every method",
    allStatuses: "Every status",
    searchOperations: "Description, reference or beneficiary",
    searchReceipts: "Receipt number or family",
    dateFrom: "From",
    dateTo: "To",
    ...
    noReceiptMatches: "No receipt matches these filters.",
    payments: "Payments",
