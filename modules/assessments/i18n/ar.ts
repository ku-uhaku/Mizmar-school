...
const ar = {
  assessment: {
    ...
    noAssessmentsHint: "ولّد سلسلة كاملة دفعة واحدة، أو أضف فرضًا واحدًا يدويًا.",
    ...
    maxScore: "من أصل",
    coefficient: "الوزن",
    coefficientHint: "الوزن داخل نقطة المادة في الدورة — وليس معامل المادة نفسها.",
    teacher: "الأستاذ",
    ...
    noProgramme: "لا توجد مادة منقّطة في برنامج هذا القسم — اضبط البرنامج أولًا.",
