...
const ar = {
  assessment: {
    ...
    noDevoirsHint:
      "تُنشأ الواجبات من فضاء الأستاذ أو من هنا من طرف الإدارة، وتظهر في هذه اللائحة في الحالتين.",

    // ── إسناد واجب من الإدارة ───────────────────────────────────────────────
    setDevoir: "إسناد واجب",
    setDevoirTitle: "إسناد واجب",
    setDevoirHint:
      "واجب واحد لقسم واحد — لزميل غائب، أو أعلنه للقسم دون تسجيله.",
    setDevoirDraftHint:
      "يُحفظ كمسودة. النشر هو ما يفتح ورقة النقط ويُخبر الأسر.",
    setDevoirNoTeaching:
      "لا يوجد أي إسناد لهذه السنة بعد — أسنِد أستاذاً إلى مادة أولاً.",
    setDevoirNoKinds:
      "لا يوجد نوع عمل مفتوح للأساتذة. افتح واحداً من الإعدادات.",
    classAndSubject: "القسم والمادة",
    classAndSubjectHint:
      "الثنائي الذي أُسند إليه الأستاذ. الواجب يعود لصاحب المنصب، لا لمن سجّله.",
    paperTitle: "العنوان",
    devoirTitlePlaceholder: "تمارين ص.42",

    // ── هل يُحتسب في الفترة ─────────────────────────────────────────────────
    countsTowardAverage: "يُحتسب في المعدل",
    countsTowardAverageHint:
      "أزل التحديد للمراجعة أو الامتحان التجريبي أو عمل يُنقَّط فقط لتحديد مستوى التلميذ. يبقى مصححاً وظاهراً — لكنه لا يحرّك معدل المادة أبداً.",
    doesNotCount: "خارج المعدل",
    makeCount: "احتسابه",
    makeNotCount: "خارج المعدل",
    nowCounts: "أصبح هذا الواجب يُحتسب في المعدل.",
    nowDoesNotCount: "لم يعد هذا الواجب يُحتسب في المعدل.",
    uncountedNeedsNoMarks:
      "لا يؤثر على الفترة، لذا يمكن إغلاقه دون أي نقطة.",
    ...
    editAssessmentHint:
      "ما دام مسودة. النشر يُخبر القسم بما سيجتازه ومتى \u2014 بعد ذلك أعده إلى المسودة لتعديله.",
    editLocked: "هذا الفرض منشور. أعده إلى المسودة قبل تعديله.",
    saved: "تم حفظ الفرض.",
