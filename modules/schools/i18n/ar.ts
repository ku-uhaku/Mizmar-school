...
const ar = {
  school: {
    ...
    hasStaff:
      "{count} موظفا يعملون في هذه المدرسة. عطّلها بدل حذفها: الحذف سيمحو ملفاتهم وكل أوراق الأجور الصادرة لهم.",
    hasCashOperations:
      "{count} حركة صندوق سُجّلت في هذه المدرسة. عطّلها بدل حذفها: الحذف سيمحو صناديقها وكل ما قُبض أو صُرف فيها.",
