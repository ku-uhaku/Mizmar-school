...
const ar = {
  transport: {
    ...
    runNotItsHour: "ليس هذا وقت هذه الرحلة. أخبر الإدارة إذا خرجت الحافلة رغم ذلك.",
    runUpcoming: "يُفتح قبل الانطلاق بساعة",
    runWindowClosed: "انقضى وقتها",
    ...
    attendantStaff: "مرافق من الموظفين",
    attendantStaffHint:
      "من يرافق التلاميذ ويقوم بالمناداة عند المحطة. عند دخوله يرى نفس الرحلات التي يراها السائق.",
    attendantNone: "بدون مرافق",
    attendantName: "المرافق",
    attendantPhone: "هاتف المرافق",
    attendantShort: "مرافق",
    ...
    wizard: {
      title: "رسم خط",
      subtitle: "الخط، والرحلات التي يقوم بها، والأحياء التي يخدمها، والأطفال القاطنون بها. يُحفظ دفعة واحدة.",
      stepOf: "الخطوة {step} من {total}",
      codeHint: "قصير وثابت، مثل L1.",
      vehicleSeats: "{count} مقعدًا في هذه الحافلة.",
      noVehicleHint: "خط بلا حافلة لا يوفّر مقاعد — يمكن إسناد واحدة لاحقًا.",
      seatsUsed: "{taken} من {seats} مقعدًا",
      neighbourhoodsHint:
        "الأحياء التي يجمع منها هذا الخط. يصبح كل حي محطة، بالترتيب المحدَّد — تُسمّى نقطة التوقف ويُضبط توقيتها لاحقًا في صفحة الخط.",
      ridersHint:
        "كل المسجَّلين غير المسنَدين إلى حافلة بعد، مرتَّبين حسب حي السكن.",
      ridersNeedNeighbourhoods:
        "حدِّد حيًّا أولًا — الركاب يتبعون منه.",
      noResidents:
        "لا يقطن هذا الحي أي مسجَّل، أو أنّ لهم مقاعد بالفعل.",
      searchRiders: "البحث بالاسم أو رقم التسجيل أو القسم",
      transportOnly: "المشتركون في النقل فقط",
      notSubscribed: "لم يشترك في النقل",
      noMatches: "لا نتائج هنا.",
      submit: "فتح الخط",
      opened: "تم فتح الخط.",
      openedPartly:
        "تم فتح الخط — سُجّل {seated} راكبًا ورُفض {refused}. قد تكون الحافلة ممتلئة أو لديهم مقعد بالفعل.",
    },
