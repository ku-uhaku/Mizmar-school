...
const en = {
  transport: {
    ...
    runNotItsHour:
      "It is not this voyage's hour. Ask the office if the bus went out all the same.",
    runUpcoming: "Opens an hour before departure",
    runWindowClosed: "Its hour has passed",
    ...
    attendantStaff: "Attendant on the payroll",
    attendantStaffHint:
      "Whoever rides with the children and takes the register at the kerb. Signing in, they see the same voyages as the driver.",
    attendantNone: "No attendant",
    attendantName: "Attendant",
    attendantPhone: "Attendant's phone",
    attendantShort: "Att.",
