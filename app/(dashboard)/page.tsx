...
/**
 * The way into the app, in two bands.
 *
 ...
 * is from the sidebar. The second band is the administration of the
 * organisation itself, which is read far less often and so sits below.
 *
