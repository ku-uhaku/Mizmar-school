...
INSERT INTO "new_school_settings" ("amoRateBps", "classWeeklyMinutes", "cnssCeilingCentimes", "cnssRateBps", "createdAt", "currencyCode", "defaultAccent", "defaultInstalmentCount", "defaultLocale", "familyCodeFormat", "feeDueDayOfMonth", "gradingMaxScore", "id", "irRateBps", "passMarkBps", "payrollWorkingDays", "schoolId", "staffCodeFormat", "studentCodeFormat", "teacherWeeklyMinutes", "teachingDays", "updatedAt") SELECT "amoRateBps", "classWeeklyMinutes", "cnssCeilingCentimes", "cnssRateBps", "createdAt", "currencyCode", "defaultAccent", "defaultInstalmentCount", "defaultLocale", "familyCodeFormat", "feeDueDayOfMonth", "gradingMaxScore", "id", "irRateBps", "passMarkBps", "payrollWorkingDays", "schoolId", "staffCodeFormat", "studentCodeFormat", "teacherWeeklyMinutes", "teachingDays", "updatedAt" FROM "school_settings";
