...
CREATE TABLE "teacher_unavailability" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "teacher_unavailability_teacherId_fkey" FOREIGN KEY ("teacherId") REFERENCES "users" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "teacher_unavailability_timeSlotId_fkey" FOREIGN KEY ("timeSlotId") REFERENCES "time_slots" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
INSERT INTO "new_timetable_entries" ("bookingKey", "classGroupId", "createdAt", "id", "roomId", "schoolClassId", "subjectId", "teacherId", "termId", "timeSlotId", "updatedAt") SELECT "bookingKey", "classGroupId", "createdAt", "id", "roomId", "schoolClassId", "subjectId", "teacherId", "termId", "timeSlotId", "updatedAt" FROM "timetable_entries";
...
-- CreateIndex
CREATE INDEX "teacher_unavailability_teacherId_idx" ON "teacher_unavailability"("teacherId");

-- CreateIndex
CREATE INDEX "teacher_unavailability_timeSlotId_idx" ON "teacher_unavailability"("timeSlotId");

-- CreateIndex
CREATE UNIQUE INDEX "teacher_unavailability_teacherId_timeSlotId_key" ON "teacher_unavailability"("teacherId", "timeSlotId");
